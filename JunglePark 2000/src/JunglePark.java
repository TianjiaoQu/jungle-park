//////////////////// HEADER COMMENT ///////////////////////////////////////////////////////////////
//
// Title:           JunglePark.java is one of nine files for JunglePark 2000, which defines 
//                  JunglePark class for the processing window of this program.
...
/**
 * This class represents the processing window in the Jungle Park application
...
public class JunglePark extends PApplet {
  ...
  // (animals and buttons, if any present, in the Jungle Park and buttons)
  ...
  public void setup() {
    ...
    listGUI.add(new AddAnimalButton("Tiger", 43, 16, this)); // Create buttons in the display window
  ...
  public void draw() {
    ...
    for (int i = 0; i < listGUI.size(); i++) {
      listGUI.get(i).draw();
      if(listGUI.get(i) instanceof Animal) // call action method for every Animal object
        ((Animal)listGUI.get(i)).action();
    }
  }
